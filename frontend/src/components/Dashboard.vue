...
<template>
  <div class="dashboard p-4">
    ...
    <div v-else>
      <div v-if="slides.length === 0" class="text-center p-4">
        <p>You haven't created any slides yet.</p>
        <Button 
          @click="createNewSlide" 
          label="Create Your First Slide" 
          icon="pi pi-plus"
          class="mt-2"
        />
      </div>
        ...
        <DataView :value="slides">
          <template #list="slotProps">
            <div class="grid grid-nogutter">
              <div 
                v-for="(slide, index) in slotProps.items" 
                :key="slide.id" 
                ...
                <Card class="h-full">
                  ...
                  <template #content>
                    ...
                    <div class="flex gap-2">
                      ...
                      />
                      <Button 
                        @click="editSlide(slide.previewHash)" 
                        label="Edit" 
                        icon="pi pi-pencil"
                        size="small"
                        severity="warning"
